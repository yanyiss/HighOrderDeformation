...
namespace CABT
{
    ...
    typedef Eigen::Matrix<scalar, 3, 35> mat3_35;
    ...
    typedef Eigen::Matrix<scalar, 35, 1> vec35s;
    typedef Eigen::Matrix<scalar, 20, 4> mat20_4;
    typedef Eigen::Matrix<scalar, 20, 20> mat20_20;
    typedef Eigen::Matrix<scalar, 35, 4> mat35_4;
    typedef Eigen::Matrix<scalar, 35, 35> mat35_35;
