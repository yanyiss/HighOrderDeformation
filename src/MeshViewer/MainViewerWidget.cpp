...
void MainViewerWidget::createViewerDialog()
{
	...
	connect(MeshParam, SIGNAL(Perform_Curve_Deformation_signal()), SLOT(Curve_Deformation()));//by hzb

	connect(MeshParam, SIGNAL(Perform_SamplingOptimization_signal()), SLOT(Curve_Morphing_Using_SamplingOptimization()));//by hzb
}
...
void MainViewerWidget::Curve_Deformation()
{
	MeshViewer->Perorm_Curve_Deformation("../src/Deformation/Bezier3d_08_source.txt");

}

void MainViewerWidget::Curve_Morphing_Using_SamplingOptimization()
{

	MeshViewer->Perorm_Curve_Morphing_Using_SamplingOptimization("../src/Data/TwiceVolumeData8/Bezier3d_08_source.txt", "../src/Data/TwiceVolumeData8/Bezier3d_08_target.txt");
