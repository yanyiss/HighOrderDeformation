...
struct MeshTraits : public OpenMesh::DefaultTraits
{
	...
	{
		int fv_id_with_m_T; 
		std::vector<int> IJ_to_sample_id; 
	};
...
struct CtrMeshTraits : public OpenMesh::DefaultTraits
{
	typedef OpenMesh::Vec3d Point;
	typedef OpenMesh::Vec3d Normal;
...
typedef OpenMesh::TriMesh_ArrayKernelT<CtrMeshTraits> CtrMesh;

struct SampleMeshTraits : public OpenMesh::DefaultTraits
{
	typedef OpenMesh::Vec3d Point;
	typedef OpenMesh::Vec3d Normal;
...
typedef OpenMesh::TriMesh_ArrayKernelT<SampleMeshTraits> SampleMesh;
